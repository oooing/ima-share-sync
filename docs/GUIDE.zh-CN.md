# IMA Share Sync — 完整使用指南

[返回简要介绍](../README.zh-CN.md)

[English](https://github.com/oooing/ima-share-sync/blob/main/docs/GUIDE.md) · **简体中文**

![IMA Share Sync：把分享中的好内容，留在自己的知识库](assets/hero-zh.svg)
...
<p align="center">
  ...
  <a href="https://github.com/oooing/ima-share-sync/blob/main/docs/GUIDE.md">English</a>
</p>
...
![同步场景：检查最近七篇，跳过五篇已有文章，保存两篇新笔记](assets/workflow-zh.svg)
...
![操作与记录示意：手动立即开始，自动同步前提醒，日志随时回看](assets/control-zh.svg)
...
- [技术说明与已知限制](TECHNICAL.md)
- [0.1.2 更新说明](releases/0.1.2.md)
- [0.1.1 更新说明](releases/0.1.1.md)
- [安全与隐私说明](../SECURITY.md)
